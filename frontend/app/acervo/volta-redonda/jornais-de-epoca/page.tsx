...
export const metadata = {
  ...
  description: "Capas e edições digitalizadas do acervo de Volta Redonda.",
  keywords: ["Volta Redonda", "jornais de época", "imprensa sindical", "acervo", "centro de memória"],
      ...
      <Section className="pt-0">
        ...
        <div className="grid gap-6 lg:grid-cols-[0.7fr_1.3fr]">
          <div className="space-y-3 rounded-3xl border border-white/10 bg-white/5 p-4 sm:p-5">
            ...
            <FilterSidebar
              filters={{ label: "Décadas", options: ["1940s", "1950s", "1960s", "1970s", "1980s", "1990s"] }}
              title="Período"
            />
          </div>
