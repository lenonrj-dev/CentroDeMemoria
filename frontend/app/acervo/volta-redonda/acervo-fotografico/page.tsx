...
export const metadata = {
  ...
  description: "Álbuns e séries do acervo fotográfico de Volta Redonda.",
  keywords: [
    "Volta Redonda",
    "acervo fotográfico",
    ...
    >
      <Section className="pt-0">
        <SectionTitle
          ...
          description="O acervo visual reúne imagens de mobilização, cotidiano fabril e cenas urbanas. Cada álbum é descrito com local, data e termos controlados para facilitar a pesquisa."
        />
        <div className="grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
          <FilterSidebar filters={{ label: "Décadas", options: ["1940s", "1950s", "1960s", "1970s", "1980s"] }} title="Período" />
          <div className="space-y-3 rounded-3xl border border-white/10 bg-white/5 p-4 sm:p-5">
            ...
            <FilterSidebar filters={{ label: "Temas", options: ["Cotidiano", "Mobilização", "Indústria", "Imprensa"] }} title="Temas" />
          </div>
        </div>
      </Section>
